  ...
  return (
    <>
      <Dimmer.Dimmable blurring active="true">
        <Image fluid src={plato} style={{ marginTop: -13 }} />{' '}
      ...
      <Header as="h1" textAlign="center">
        <Header.Content className="weak">Data science and full stack solutions</Header.Content>
        <Header.Subheader className="weak">The future of every economy in the world</Header.Subheader>
      </Header>
      ...
      <Container>
        <Segment vertical padded="very">
          ...
          <p>
            Large sectors of industry haven&apos;t actualized the power of machine learning/AI. Others haven&apos;t
            locked in a foothold with the new tools of the information age. Some are still stuck in the industrial
            revolution. In order to keep your business at the edge, we offer expert solutions that can propel you into
            the future of machine learning and the information age.
          </p>

          <p>
            Companies that adopt cutting edge technology in this way are more than just ahead; they&apos;re several
            paradigm shifts in the future. We&apos;re here to do it for you when you can&apos;t do it yourself.
          </p>
        </Segment>

        <Segment vertical padded="very">
          <Header as="h1" textAlign="center">
            <Header.Content className="weak">Avoid old school thought</Header.Content>
            <Header.Subheader className="weak">Get ahead for less when you avoid large corporations</Header.Subheader>
          </Header>

          <p>
            Our experts have witnessed firsthand that large corporations act inefficiently, implementing solutions that
            don&apos;t scale, don&apos;t anticipate the future, cost too much and worst of all &mdash; don&apos;t work.
            So many companies out there fall victim to one of these tech sins:
          </p>
            ...
            <Grid.Row columns={2}>
              <Grid.Column floated="left">
                <LineChart width={350} height={350} data={data}>
                  <XAxis dataKey="name" label={<Label value="months" offset={0} position="insideBottom" />} />
                  <YAxis unit="K" />
