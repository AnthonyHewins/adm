...
const PolynomialRegressionApi: React.FC<ApiProps> = ({ endpoint = '/api/tools/poly-reg' }) => {
  return (
    <>
      ...
      <p>This endpoint runs polynomial regression using BLAS golang bindings. It makes use of the normal equation.</p>
...
export default PolynomialRegressionApi;
